...
public class EstagiarioData extends DataFactory {
    ...
    public static ColaboradorModel gerarEstagiarioValido(Integer idTrilha) {
        ...
        String uf = DataFakerGenerator.estadoFaker();
        estagiario.setEstado(uf);
        estagiario.setCidade(DataFakerGenerator.capitalPorSigla(uf));
        estagiario.setCurso(DataFakerGenerator.cursoFaker());
        estagiario.setInstituicaoEnsino(DataFakerGenerator.instituicaoDeEnsinoFaker());
